...
<%@include file="../ClientBoard/boardHeader.jsp" %>
			...
			<h2 class="col-4 sub_tit_wrap h2">공지사항 수정</h2>
		...
		<div class="accordion" id="accordionExample">
			<form action="" method="post" role="form">
				...
				<div class="card">
					...
					<div class="card-body">
						<textarea class="form-control" rows="15" name="content">${selectBoard.content}</textarea> 
					</div>
				</div>
...
<script src="/resources/js/Notice_js/update.js"></script>
