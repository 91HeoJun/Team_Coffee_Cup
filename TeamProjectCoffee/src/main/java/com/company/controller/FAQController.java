...
import com.company.service.FAQService;
...
public class FAQController {
	...
	public void selectForm(int bno, @ModelAttribute("cri") Criteria cri, Model model) {
		...
		BoardVO selectBoard = faqService.getRow(bno);
	...
	public void allList(Model model, Criteria cri) {
		...
		List<BoardVO> list = faqService.getList(cri);
		
		int total = faqService.getTotalCnt(cri);
